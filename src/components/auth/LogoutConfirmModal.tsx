  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                Pekerjaan Anda otomatis tersimpan aman di perangkat ini
              </p>
            </div>
          </div>
          <button
        ...
        {/* User & Device Storage Badge Info (Tanpa Email Verifikasi) */}
          ...
          <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-2xl flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-white truncate">
                {user.name || "Pengguna Studio"}
              </p>
              <p className="text-[11px] text-slate-400 flex items-center gap-1">
                <span>Perangkat Ini</span>
                <span className="text-slate-600">•</span>
                <span className="text-emerald-400 font-medium">Penyimpanan Lokal Aktif</span>
              </p>
            </div>
            <span className="text-[10px] px-2.5 py-1 rounded-full bg-emerald-500/20 text-emerald-300 font-medium shrink-0 border border-emerald-500/30 flex items-center gap-1.5">
        ...
        <div className="p-6 space-y-3">
          {/* Option 1: Simpan di Perangkat & Keluar (Default) */}
          <button
            type="button"
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-bold text-white">
                  Keluar & Simpan di Perangkat Ini
                </span>
              ...
              <p className="text-[11px] text-slate-300/85 leading-relaxed">
                Seluruh proyek (kode index.html, riwayat instruksi AI, dan pengaturan) tersimpan
                aman di memori perangkat ini. Saat Anda kembali membuka studio pada perangkat yang
                sama, pekerjaan terakhir Anda tidak akan hilang dan langsung dimuat kembali secara
                otomatis.
              </p>
            </div>
          </button>

          {/* Option 2: Bersihkan Penyimpanan di Perangkat */}
          <button
            type="button"
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-bold text-rose-200">
                  Bersihkan Penyimpanan di Perangkat Ini & Keluar
                </span>
              ...
              <p className="text-[11px] text-rose-300/80 leading-relaxed">
                Hapus semua kode proyek dan riwayat obrolan yang tersimpan di perangkat ini sebelum keluar.
              </p>
              {selectedMode === "hard" && (
                <div className="mt-2.5 p-2.5 rounded-xl bg-rose-950/60 border border-rose-500/40 flex items-start gap-2 text-rose-200 text-[10px] leading-relaxed">
                  ...
                  <span>
                    <strong>Peringatan:</strong> Kode proyek yang belum di-download atau di-push ke
                    GitHub akan terhapus dari perangkat ini.
                  </span>
                </div>
              )}
            </div>
        ...
        <div className="px-6 py-4 border-t border-slate-800 bg-slate-950/90 flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-[10px] text-slate-400 font-medium">
            ...
            <span>Sesi Aman & Tersimpan Lokal</span>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            {selectedMode === "smart" ? (
              ...
              >
                ...
                <span>Keluar & Simpan di Perangkat</span>
              </button>
            ) : (
              <button
                type="button"
